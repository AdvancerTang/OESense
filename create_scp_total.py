...
def total_data(persons, total_wav_dir):
    ...
    for person in persons:
        single_train_path = r"F:\OESense\wave_dir\data_{}_train_1".format(person)
        single_val_path = r"F:\OESense\wave_dir\data_{}_val_1".format(person)
...
if __name__ == '__main__':
    ...
    scp_path = r'F:\OESense\total_dir\total_data'
